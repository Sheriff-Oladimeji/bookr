    ...
    <div className="mb-20 font-mont">
      <div className="w-[90%] md:w-[80%] mx-auto flex flex-col md:flex-row gap-10 mt-6 pt-32">
        ...
        <div className="bg-[#18191B] h-[350px]  w-full md:w-[35%] max-w-[500px] text-center relative py-8">
          <div className=" w-[80%] mx-auto  bg-white p-4  h-[60px] relative rounded-md">
            <span
              className="flex flex-row-reverse items-center gap-2  md:w-full mx-auto"
          ...
          <Link to="/cart">
            <button className="border-2 border-brown p-4 w-[60%] md:w-[80%] rounded-lg  mt-8 bg-brown font-semibold text-white text-center">Add to cart</button>
          </Link>
        </div>
      </div>
    </div>
